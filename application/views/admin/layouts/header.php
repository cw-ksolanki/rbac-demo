...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .nav-item a:hover { background: #f0f0ff; color: #4f46e5; }
        .nav-item a.active { background: #eef2ff; color: #4f46e5; font-weight: 600; }
...
.topbar-user a:hover { background: #f5f5ff; color: #4f46e5; }
.topbar-user .avatar {
...
<div id="sidebar">
    <div class="sidebar-brand">
        <i class="bi bi-hexagon-fill me-2"></i>AdminPanel
    </div>
