...
<head>
    ...
    <title><?= isset($page_title) ? $page_title . ' — Driver' : 'Driver Panel' ?></title>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .nav-item a:hover  { background: #fffbeb; color: #f59e0b; }
        .nav-item a.active { background: #fef3c7; color: #d97706; font-weight: 600; }
        .nav-item a i { font-size: 16px; }
        .sidebar-footer { padding: 16px; border-top: 1px solid #e9ecef; }
        .sidebar-footer a {
        ...
        .topbar-user a:hover { background: #fffbeb; color: #f59e0b; }
        .topbar-user .avatar {
...
<div id="sidebar">
    <div class="sidebar-brand">
        <i class="bi bi-truck me-2"></i>Driver Panel
    </div>
    <?php $this->load->view('driver/layouts/sidebar'); ?>
</div>
...
<div id="main">
    <div id="topbar">
        ...
        <div class="topbar-user">
            <a href="<?= site_url('driver/profile') ?>">
                <div class="avatar">
                ...
                <div>
                    ...
                    <div style="font-size:11px;color:#adb5bd;">Driver</div>
                </div>
